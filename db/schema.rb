...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "order_items", id: { type: :bigint, unsigned: true }, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.float "vn_transport_fee", default: 0.0, null: false
    t.float "clearance_fee", default: 0.0, null: false
    t.float "estimated_fee", default: 0.0, null: false
    t.float "imported_fee", default: 0.0, null: false
    t.float "jp_to_vnd", default: 0.0, null: false
    t.float "vat_tax", default: 0.0, null: false
    t.float "bank_transport_fee", default: 0.0, null: false
    t.float "registry_fee", default: 0.0, null: false
    t.float "total_price", default: 0.0, null: false
    t.float "entrustment_fee", default: 0.0, null: false
    t.float "final_price", default: 0.0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
